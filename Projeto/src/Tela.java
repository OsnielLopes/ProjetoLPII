...
public class Tela {
    ...
    public static String[] getInfoLeituraArquivo() {
        ...
        do {
            ...
            result = JOptionPane.showOptionDialog(null, panel, "Tabela de Jogos",
                    JOptionPane.YES_NO_OPTION, JOptionPane.PLAIN_MESSAGE, null, opcoes, null);
            ...
            arquivo = textFieldNomeArquivo.getText();
            separador = textFieldSeparador.getText();
        } while (arquivo.isEmpty() || arquivo.equals(" ") || separador.isEmpty() || separador.equals(" "));
    ...
    public static Filtro escolheFormaPesquisa() {
        ...
        ImageIcon img = new ImageIcon("jogadormenor.jpg");
        //bmt
        JOptionPane.showMessageDialog(null, panel, "Tabela de Jogos", 0, img);
